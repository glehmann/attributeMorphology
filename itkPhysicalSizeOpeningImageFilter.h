...
/**
 * \class PhysicalSizeOpeningImageFilter
...
public:
  ...
  typedef AttributeMorphologyBaseImageFilter<TInputImage, TOutputImage, typename TInputImage::SpacingType::ValueType, std::greater<typename TInputImage::PixelType> >
                                         Superclass;
